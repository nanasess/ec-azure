...
CREATE TABLE mtb_zip (
    id int,
    code nvarchar(max),
    old_zipcode nvarchar(max),
    zipcode nvarchar(max),
    state_kana nvarchar(max),
    city_kana nvarchar(max),
    town_kana nvarchar(max),
    state nvarchar(max),
    city nvarchar(max),
    town nvarchar(max),
    flg1 nvarchar(max),
...
CREATE TABLE dtb_order (
    ...
    use_point numeric(9),
    add_point numeric(9),
    birth_point numeric(9) DEFAULT 0,
    tax numeric(9),
    total numeric(9),
...
CREATE TABLE dtb_order_temp (
    order_temp_id varchar(64) NOT NULL,
    customer_id int NOT NULL,
    message nvarchar(max),
    order_name01 nvarchar(max),
    order_name02 nvarchar(max),
...
CREATE TABLE dtb_plugin (
    ...
    plugin_setting_path nvarchar(max),
